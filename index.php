    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <?php
                ...
                <!-- First Blog Post -->
                <h2>
                    <a href="post1.php?p_id=<?php echo $post_id; ?>"><?php echo $post_title?></a>
                </h2>
                <p class="lead">
                ...
                <hr>
                <a href="post1.php?p_id=<?php echo $post_id; ?>"><img class="img-responsive" src="images/<?php echo $post_image?>" alt=""></a>
                <hr>
                <p><?php echo $post_content ?></p>
                <a class="btn btn-primary" href="post1.php?p_id=<?php echo $post_id;?>">Read More <span class="glyphicon glyphicon-chevron-right"></span></a>
